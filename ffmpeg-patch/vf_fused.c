/*
 * Dynamic lavfi-cc RGB and YUV kernel filter.
 *
...
/* Above eight bits every sample is a little-endian uint16, which changes the
 * bytes in a row but not the plane geometry, so nothing below has to know. */
...
static enum AVPixelFormat kernel_pixel_format(uint32_t identifier)
{
    ...
    case LAVFI_PIXEL_FORMAT_YUV444P9LE:   return AV_PIX_FMT_YUV444P9LE;
    case LAVFI_PIXEL_FORMAT_YUV422P9LE:   return AV_PIX_FMT_YUV422P9LE;
    case LAVFI_PIXEL_FORMAT_YUV420P9LE:   return AV_PIX_FMT_YUV420P9LE;
    case LAVFI_PIXEL_FORMAT_YUV444P10LE:  return AV_PIX_FMT_YUV444P10LE;
    case LAVFI_PIXEL_FORMAT_YUV422P10LE:  return AV_PIX_FMT_YUV422P10LE;
    case LAVFI_PIXEL_FORMAT_YUV420P10LE:  return AV_PIX_FMT_YUV420P10LE;
    case LAVFI_PIXEL_FORMAT_YUV444P12LE:  return AV_PIX_FMT_YUV444P12LE;
    case LAVFI_PIXEL_FORMAT_YUV422P12LE:  return AV_PIX_FMT_YUV422P12LE;
    case LAVFI_PIXEL_FORMAT_YUV420P12LE:  return AV_PIX_FMT_YUV420P12LE;
    case LAVFI_PIXEL_FORMAT_YUV444P14LE:  return AV_PIX_FMT_YUV444P14LE;
    case LAVFI_PIXEL_FORMAT_YUV422P14LE:  return AV_PIX_FMT_YUV422P14LE;
    case LAVFI_PIXEL_FORMAT_YUV420P14LE:  return AV_PIX_FMT_YUV420P14LE;
    case LAVFI_PIXEL_FORMAT_YUV444P16LE:  return AV_PIX_FMT_YUV444P16LE;
    case LAVFI_PIXEL_FORMAT_YUV422P16LE:  return AV_PIX_FMT_YUV422P16LE;
    case LAVFI_PIXEL_FORMAT_YUV420P16LE:  return AV_PIX_FMT_YUV420P16LE;
    case LAVFI_PIXEL_FORMAT_YUVA444P10LE: return AV_PIX_FMT_YUVA444P10LE;
    case LAVFI_PIXEL_FORMAT_YUVA422P10LE: return AV_PIX_FMT_YUVA422P10LE;
    case LAVFI_PIXEL_FORMAT_YUVA420P10LE: return AV_PIX_FMT_YUVA420P10LE;
    case LAVFI_PIXEL_FORMAT_YUVA444P16LE: return AV_PIX_FMT_YUVA444P16LE;
    case LAVFI_PIXEL_FORMAT_YUVA422P16LE: return AV_PIX_FMT_YUVA422P16LE;
    case LAVFI_PIXEL_FORMAT_YUVA420P16LE: return AV_PIX_FMT_YUVA420P16LE;
    case LAVFI_PIXEL_FORMAT_GBRP9LE:   return AV_PIX_FMT_GBRP9LE;
    case LAVFI_PIXEL_FORMAT_GBRP10LE:  return AV_PIX_FMT_GBRP10LE;
    case LAVFI_PIXEL_FORMAT_GBRAP10LE: return AV_PIX_FMT_GBRAP10LE;
    case LAVFI_PIXEL_FORMAT_GBRP12LE:  return AV_PIX_FMT_GBRP12LE;
    case LAVFI_PIXEL_FORMAT_GBRAP12LE: return AV_PIX_FMT_GBRAP12LE;
    case LAVFI_PIXEL_FORMAT_GBRP14LE:  return AV_PIX_FMT_GBRP14LE;
    case LAVFI_PIXEL_FORMAT_GBRP16LE:  return AV_PIX_FMT_GBRP16LE;
    case LAVFI_PIXEL_FORMAT_GBRAP16LE: return AV_PIX_FMT_GBRAP16LE;
    case LAVFI_PIXEL_FORMAT_RGB48LE:   return AV_PIX_FMT_RGB48LE;
    case LAVFI_PIXEL_FORMAT_RGBA64LE:  return AV_PIX_FMT_RGBA64LE;
    case LAVFI_PIXEL_FORMAT_BGR48LE:   return AV_PIX_FMT_BGR48LE;
    case LAVFI_PIXEL_FORMAT_BGRA64LE:  return AV_PIX_FMT_BGRA64LE;
    case LAVFI_PIXEL_FORMAT_YUV411P8:     return AV_PIX_FMT_YUV411P;
    case LAVFI_PIXEL_FORMAT_YUV410P8:     return AV_PIX_FMT_YUV410P;
    case LAVFI_PIXEL_FORMAT_YUV440P8:     return AV_PIX_FMT_YUV440P;
    case LAVFI_PIXEL_FORMAT_YUVJ444P8:    return AV_PIX_FMT_YUVJ444P;
    case LAVFI_PIXEL_FORMAT_YUVJ422P8:    return AV_PIX_FMT_YUVJ422P;
    case LAVFI_PIXEL_FORMAT_YUVJ420P8:    return AV_PIX_FMT_YUVJ420P;
    case LAVFI_PIXEL_FORMAT_YUVJ440P8:    return AV_PIX_FMT_YUVJ440P;
    case LAVFI_PIXEL_FORMAT_YUV440P10LE:  return AV_PIX_FMT_YUV440P10LE;
...
const FFFilter ff_vf_fused = {
    ...
    .p.description = NULL_IF_CONFIG_SMALL(
        "Run one checked lavfi-cc RGB or YUV kernel."),
